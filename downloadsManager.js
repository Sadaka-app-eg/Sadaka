...
window.dmRareReciters = ["محمد عباده", "منشاوي", "أحمد النفيس", "حسن فهمي", "أسامة عمران", "عبدالرحمن مسعد", "إسلام صبحي", "ياسر الدوسري", "محمود علي البنا", "شعبان الصياد", "أحمد كاسب", "أحمد عبدالرازق نصر", "أحمد بن طالب", "أحمد السعيد مندور", "عمر بن ضياء الدين", "عبدالله الخلف", "جابر القيطان", "أدعية خاشعة", "أناشيد"];
