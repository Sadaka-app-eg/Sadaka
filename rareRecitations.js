...
// ==========================================
 window.rareRecitations = [
  ...
  { name: "دعاء الوتر 6 رمضان  🤲", url: "audio/doaa_1.mp3", desc: "", tag: "محمد عبادة" },
  { name: "يا ملاذ الهاربين ويا أمان الخائفين ... دعاء ليلة 27 رمضان  🤲", url: "audio/doaa_2.mp3", desc: "", tag: "محمد زاهر البارقي" },
  { name: "يا حبيب التائبين . يا أنيس الخائفين 🤲", url: "audio/doaa_3.mp3", desc: "", tag: "محمد عبادة" },
  { name: " بكاء وتضرع دعاء ليلة 27 رمضان 🤲", url: "audio/doaa_4.mp3", desc: "", tag: "إسلام صبحي" },
  { name: "ربي ما أرحمك دعاء ليلة 27 رمضان 🤲", url: "audio/doaa_5.mp3", desc: "", tag: "حاتم فريد الواعر" },
  { name: "يا فرجنا إذا أغلقت الأبواب  🤲", url: "audio/doaa_6.mp3", desc: "", tag: "ياسر الدوسري" },
  { name: "دعاء يريح النفس 🤲", url: "audio/doaa_7.mp3", desc: "", tag: "منصور السالمي" },
  { name: "دعاء يبكي الحجر 🤲", url: "audio/doaa_8.mp3", desc: "", tag: "منصور السالمي" }
