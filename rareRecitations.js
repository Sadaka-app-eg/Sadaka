...
// ==========================================
 ...
 // أدعية خاشعة المرفوعة من 1 إلى 8
  { name: " دعاء الوتر 6 رمضان للشيخ محمد عبادة  🤲", url: "audio/doaa_1.mp3", desc: "", tag: "أدعية خاشعة" },
  { name: "يا ملاذ الهاربين ويا أمان الخائفين ... دعاء ليلة 27 رمضان للقارئ محمد زاهر البارقي  🤲", url: "audio/doaa_2.mp3", desc: "", tag: "أدعية خاشعة" },
  { name: "يا حبيب التائبين . يا أنيس الخائفين للشيخ محمد عبادة 🤲", url: "audio/doaa_3.mp3", desc: "", tag: "أدعية خاشعة" },
  { name: " بكاء وتضرع دعاء ليلة 27 رمضان للشيخ إسلام صبحي🤲", url: "audio/doaa_4.mp3", desc: "", tag: "أدعية خاشعة" },
  { name: "ربي ما أرحمك دعاء ليلة 27 رمضان للشيخ حاتم فريد الواعر 🤲", url: "audio/doaa_5.mp3", desc: "", tag: "أدعية خاشعة" },
  { name: "يا فرجنا إذا أغلقت الأبواب للشيخ ياسر الدوسري 🤲", url: "audio/doaa_6.mp3", desc: "", tag: "أدعية خاشعة" },
